...
import image2 from '../../../images/senora.jpg';
...
export const HomeComponent = () => {
    ...
    return (
        ...
        <Carousel>
        <Carousel.Item>
            <img style={imgSize} src={image} alt="background image1"/>
            <Carousel.Caption>
        ...
        <Carousel.Item>
            <img style={imgSize}  src={image3} alt="background image2"/>
            <Carousel.Caption>
        ...
        <Carousel.Item>
            <img style={imgSize} src={image2} alt="background image3"/>
            <Carousel.Caption>
